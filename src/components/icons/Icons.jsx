// Ícones reutilizados pela interface. Mantidos pequenos e sem cor fixa
// (herdam `currentColor`) para se adaptarem ao componente que os usa.

const base = "w-4 h-4";

export function RouteIcon({ className = "w-6 h-6" }) {
  return (
...
export function BoxIcon({ className = base }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
